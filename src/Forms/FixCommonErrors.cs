    ...
    public sealed partial class FixCommonErrors : Form
    {
        ...
        private void AddFixActions(string threeLetterIsoLanguageName)
        {
            ...
            if (string.IsNullOrEmpty(_language.FixInvalidEllipses))
                _fixActions.Add(new FixItem("Fix Ellipses", "Foobar.. -> Foobar...", new Action(FixInvalidEllipses), ce.FixInvalidEllipsesTicked));
            else
                _fixActions.Add(new FixItem(_language.FixInvalidEllipses, "Foobar.. -> Foobar...", new Action(FixInvalidEllipses), ce.FixInvalidEllipsesTicked));
