    ...
    public partial class SubStationAlphaStyles : StylesForm
    {
        ...
        protected override void GeneratePreviewReal()
        {
            ...
            using (Graphics g = Graphics.FromImage(bmp))
            {
                ...
                TextDraw.DrawText(font, sf, path, sb.ToString(), checkBoxFontItalic.Checked, checkBoxFontBold.Checked, checkBoxFontUnderline.Checked, left, top, ref newLine, leftMargin, ref pathPointsStart);
