...
namespace Nikse.SubtitleEdit.Forms
{
    public sealed partial class GoogleTranslate : PositionAndSizeForm
    {
        ...
        private void buttonTranslate_Click(object sender, EventArgs e)
        {
            ...
            {
                Translate(source, _targetTwoLetterIsoLanguageName, new MicrosoftTranslator(Configuration.Settings.Tools.MicrosoftTranslatorApiKey), 1000, MicrosoftTranslator.MaximumRequestArrayLength);
            }
        }
