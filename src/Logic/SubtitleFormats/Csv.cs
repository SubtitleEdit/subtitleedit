...
namespace Nikse.SubtitleEdit.Logic.SubtitleFormats
{
    public class Csv : SubtitleFormat
    {
        ...
        public override string ToText(Subtitle subtitle, string title)
        {
            ...
            sb.AppendLine(string.Format(format, Seperator, "Number", "Start time in milliseconds", "End time in milliseconds", "Text"));
            foreach (Paragraph p in subtitle.Paragraphs)
            {
                sb.AppendLine(string.Format(format, Seperator, p.Number, p.StartTime.TotalMilliseconds, p.EndTime.TotalMilliseconds, p.Text.Replace(Environment.NewLine, "\n")));
            }
