...
namespace Nikse.SubtitleEdit.Logic.SubtitleFormats
{
    public class SwiftTextLineNumber : SubtitleFormat
    {
        ...
        static readonly Regex RegexTimeCodes = new Regex(@"^SUBTITLE: \d+\s+TIMEIN:\s*[0123456789-]+:[0123456789-]+:[0123456789-]+:[0123456789-]+\s*TIMEOUT:\s*[0123456789-]+:[0123456789-]+:[0123456789-]+:[0123456789-]+$", RegexOptions.Compiled);
