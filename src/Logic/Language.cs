    ...
    public class Language
    {
        ...
        public Language()
        {
            ...
            FixCommonErrors = new LanguageStructure.FixCommonErrors
            {
                ...
                StartTimeLaterThanEndTime = "Text number {0}: Start time is later end end time: {4}{1} --> {2} {3}",
                ...
                FixMusicNotation = "Replace music symbols (e.g. âTª) with prefered symbol",
            ...
            Main = new LanguageStructure.Main
            {
                ...
                VideoControls = new LanguageStructure.Main.MainVideoControls 
                {
                    ...
                    SecondsBackShort = "<< secs",
                    SecondsForwardShort = "secs >>",
            ...
            Settings = new LanguageStructure.Settings
            {
                ...
                WindowsMediaPlayerDescription = "WMP ActiveX control",
                ...
                VolumeNotes = "0 is no sound, 100 is higest volume",
