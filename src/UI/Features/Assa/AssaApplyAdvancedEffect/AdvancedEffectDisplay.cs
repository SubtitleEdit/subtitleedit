...
{
    public string Name => "Transition - TV close";
    public string Description => "Black bars grow inward from top and bottom while the middle fades to white (black top / white middle / black bottom). Second half is solid black.";
    public bool UsesAudio => false;
