...
public partial class TimedTextImsc11PropertiesViewModel : ObservableObject
{
    ...
    public TimedTextImsc11PropertiesViewModel()
    {
    ...
    public void Initialize(Subtitle subtitle)
    {
        ...
        {
            header = new TimedTextImsc11().ToText(new Subtitle(), "tt");
        ...
        try
        {
            ...
            var bodyStyleAttr = root.Element(tt + "body")?.Attribute("style")
                                ?? root.Descendants(tt + "body").FirstOrDefault()?.Attribute("style");
            ...
            var bodyRegionAttr = root.Element(tt + "body")?.Attribute("region")
                                 ?? root.Descendants(tt + "body").FirstOrDefault()?.Attribute("region");
        ...
        // File extension
        var fileExt = Configuration.Settings.SubtitleSettings.TimedTextImsc11FileExtension;
    ...
    private void WriteValuesToXml()
    {
        ...
        try
        {
            ...
            // Title
            var metadataNode = root.Descendants(tt + "metadata").FirstOrDefault()
                               ?? root.Descendants("metadata").FirstOrDefault();
            ...
            else
            {
                if (metadataNode == null)
                {
                    ...
                    metadataNode = new XElement(tt + "metadata");
            ...
            // body style
            var body = root.Element(tt + "body") ?? root.Descendants(tt + "body").FirstOrDefault();
            if (body != null)
            {
