...
public class SsaStylesWindow : Window
{
    public SsaStylesWindow(SsaStylesViewModel vm)
    {
    ...
    private static Border MakeFileStyles(SsaStylesViewModel vm)
    {
        var grid = new Grid
        {
            RowDefinitions =
    ...
    private static Border MakeStorageStyles(SsaStylesViewModel vm)
    {
        var grid = new Grid
        {
            RowDefinitions =
    ...
    private static Grid MakeRightView(SsaStylesViewModel vm)
    {
        var grid = new Grid
        {
            RowDefinitions =
    ...
    private static Border MakeAlignmentView(SsaStylesViewModel vm)
    {
        var grid = new Grid
        {
            RowDefinitions =
    ...
    private static Border MakeMarginView(SsaStylesViewModel vm)
    {
        var grid = new Grid
        {
            RowDefinitions =
    ...
    private static Border MakeBorderView(SsaStylesViewModel vm)
    {
        var grid = new Grid
        {
            RowDefinitions =
    ...
    private static Border MakePreviewView(SsaStylesViewModel vm)
    {
        var grid = new Grid
        {
            RowDefinitions =
    ...
    private static Button MakeStyleColorPickerButton(SsaStylesViewModel vm, string colorPropertyName)
    {
        ...
        button.Click += async (_, _) =>
        {
            ...
            {
                propInfo?.SetValue(vm.CurrentStyle, SsaStylesViewModel.WithoutAlpha(pickerVm.SelectedColor));
            }
        };
