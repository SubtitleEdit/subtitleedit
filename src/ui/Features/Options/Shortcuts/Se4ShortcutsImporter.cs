...
public static class Se4ShortcutsImporter
{
    ...
    private static readonly Dictionary<string, string> Map = new(StringComparer.Ordinal)
    {
        ...
        ["MainAdjustSnapStartToNextShotChange"] = nameof(MainViewModel.SnapSelectedLinesToNearestShotChangeCommand),
        ["MainAdjustSnapEndToPreviousShotChange"] = nameof(MainViewModel.SnapSelectedLinesToNearestShotChangeCommand),
        ["MainAutoBalanceSelectedLines"] = nameof(MainViewModel.AutoBreakCommand),
        ["MainMergeDialogWithNext"] = nameof(MainViewModel.MergeWithLineAfterCommand),
        ["MainMergeDialogWithPrevious"] = nameof(MainViewModel.MergeWithLineBeforeCommand),
