...
public static class Se4ShortcutsImporter
{
    ...
    private static readonly Dictionary<string, string> Map = new(StringComparer.Ordinal)
    {
        ...
        ["MainListViewSortByDuration"] = nameof(MainViewModel.SortByDurationCommand),
        ["MainListViewSortByGap"] = nameof(MainViewModel.SortByGapCommand),
        ["MainListViewSortByText"] = nameof(MainViewModel.SortByTextCommand),
        ["MainListViewSortByTextTotalLength"] = nameof(MainViewModel.SortByTextTotalLengthCommand),
        ["MainListViewSortBySingleLineMaxLen"] = nameof(MainViewModel.SortBySingleLineMaxLengthCommand),
        ["MainListViewSortByCps"] = nameof(MainViewModel.SortByCpsCommand),
        ["MainListViewSortByWpm"] = nameof(MainViewModel.SortByWpmCommand),
        ["MainListViewSortByNumberOfLines"] = nameof(MainViewModel.SortByNumberOfLinesCommand),
        ["MainListViewSortByActor"] = nameof(MainViewModel.SortByActorCommand),
        ["MainListViewSortByStyle"] = nameof(MainViewModel.SortByStyleCommand),
        ...
        ["MainAdjustSetStartKeepDuration"] = nameof(MainViewModel.WaveformSetStartAndKeepDurationCommand),
        ...
        ["MainAdjustSetEndMinusGapAndStartNextHere"] = nameof(MainViewModel.WaveformSetEndAndStartOfNextAfterGapCommand),
        ...
        ["MainEvenlyDistributeSelectedLines"] = nameof(MainViewModel.EvenlyDistributeSelectedLinesCommand),
