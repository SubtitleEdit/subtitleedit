...
public class Qwen3TtsSettingsWindow : Window
{
    private const int LabelWidth = 110;
    private const int ValueWidth = 360;

    private readonly Qwen3TtsSettingsViewModel _vm;

    public Qwen3TtsSettingsWindow(Qwen3TtsSettingsViewModel vm)
    {
        UiUtil.InitializeWindow(this, GetType().Name);
        Title = Se.Language.Video.TextToSpeech.Qwen3TtsSettings;
    ...
    private static Border BuildDetails(Qwen3TtsSettingsViewModel vm)
    {
        var grid = new Grid
        {
            ColumnDefinitions =
