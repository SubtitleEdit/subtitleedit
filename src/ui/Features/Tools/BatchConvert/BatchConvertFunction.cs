...
public partial class BatchConvertFunction : ObservableObject
{
    ...
    public static BatchConvertFunction[] List(BatchConvertViewModel vm)
    {
        ...
        return new List<BatchConvertFunction>()
        {
            ...
            MakeFunction(BatchConvertFunctionType.SnapTimeCodesToFrames, Se.Language.Main.Menu.SnapAllTimesToFrames, ViewSnapTimeCodesToFrames.Make(vm), activeFunctions),
