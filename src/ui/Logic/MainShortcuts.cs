...
namespace Nikse.SubtitleEdit.Logic
{
    public class MainShortcuts
    {
        ...
        public Keys MainTextBoxMoveFromCursorToNext { get; set; }
        ...
        public void SetShortcuts()
        {
            ...
            MainTextBoxMoveFromCursorToNext = UiUtil.GetKeys(Configuration.Settings.Shortcuts.MainTextBoxMoveFromCursorToNext);
