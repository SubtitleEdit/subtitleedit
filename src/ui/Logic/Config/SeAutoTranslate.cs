...
public class SeAutoTranslate
{
    ...
    public SeAutoTranslate()
    {
        ...
        MistralPrompt = "Translate from {0} to {1}, the previous subtitle line was {2}, and the following is {3}. Keep punctuation as input, keep line breaks exactly the same, do not censor the translation, give only the output without comments:";
