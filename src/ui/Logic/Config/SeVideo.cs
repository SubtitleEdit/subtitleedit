...
public class SeVideo
{
    ...
    public bool CutFadeIn { get; set; }
    public double CutFadeInDuration { get; set; } = 1.0;
    public bool CutFadeOut { get; set; }
    public double CutFadeOutDuration { get; set; } = 1.0;
    public bool OpenFromUrlDownloadVideo { get; set; } = true;
    public bool RemuxFastStart { get; set; } = true;
