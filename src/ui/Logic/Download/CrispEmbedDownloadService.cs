...
public class CrispEmbedDownloadService : ICrispEmbedDownloadService
{
    ...
    private const string WindowsCudaUrl = "https://github.com/CrispStrobe/CrispEmbed/releases/download/v0.17.5/crispembed-windows-x86_64-cuda.zip";
    private const string WindowsVulkanUrl = "https://github.com/CrispStrobe/CrispEmbed/releases/download/v0.17.5/crispembed-windows-x86_64-vulkan.zip";
    private const string WindowsCpuUrl = "https://github.com/CrispStrobe/CrispEmbed/releases/download/v0.17.5/crispembed-windows-x86_64.zip";
    private const string MacUrl = "https://github.com/CrispStrobe/CrispEmbed/releases/download/v0.17.5/crispembed-macos-arm64.tar.gz";
    private const string LinuxUrl = "https://github.com/CrispStrobe/CrispEmbed/releases/download/v0.17.5/crispembed-linux-x86_64.tar.gz";
    ...
    private const string LinuxCudaUrl = "https://github.com/CrispStrobe/CrispEmbed/releases/download/v0.17.5/crispembed-linux-x86_64-cuda-bundled.tar.gz";
    private const string LinuxArmUrl = "https://github.com/CrispStrobe/CrispEmbed/releases/download/v0.17.5/crispembed-linux-arm64.tar.gz";
