...
public class CrispAsrDownloadService : ICrispAsrDownloadService
{
    ...
    private const string WindowsCudaUrl = "https://github.com/CrispStrobe/CrispASR/releases/download/v0.8.33/crispasr-windows-x86_64-cuda.zip";
    /// <summary>
    ...
    /// </summary>
    private const string WindowsCuda13Url = "https://github.com/CrispStrobe/CrispASR/releases/download/v0.8.33/crispasr-windows-x86_64-cuda13.zip";
    private const string WindowsVulkanUrl = "https://github.com/CrispStrobe/CrispASR/releases/download/v0.8.33/crispasr-windows-x86_64-vulkan.zip";
    private const string WindowsCpuUrl = "https://github.com/CrispStrobe/CrispASR/releases/download/v0.8.33/crispasr-windows-x86_64-cpu.zip";
    private const string WindowsCpuLegacyUrl = "https://github.com/CrispStrobe/CrispASR/releases/download/v0.8.33/crispasr-windows-x86_64-cpu-legacy.zip";
    private const string MacUrl = "https://github.com/CrispStrobe/CrispASR/releases/download/v0.8.33/crispasr-macos.tar.gz";
    ...
    /// </summary>
    private const string MacIntelUrl = "https://github.com/SubtitleEdit/support-files/releases/download/crispasr-0833-macos-x64/crispasr-macos-x86_64.tar.gz";
    private const string LinuxUrl = "https://github.com/CrispStrobe/CrispASR/releases/download/v0.8.33/crispasr-linux-x86_64.tar.gz";
    /// <summary>
    /// The two Linux CUDA tarballs lag the rest of the pin at v0.8.32: upstream's v0.8.33
    /// release run failed both <c>build-linux-x86_64-cuda</c> jobs - the CLI could not link
    /// against the shared library ("undefined reference to `ggml_backend_is_cuda'") - so
    /// neither <c>crispasr-linux-x86_64-cuda.tar.gz</c> nor its cuda13 sibling exists on the
    /// v0.8.33 tag. A blanket version bump would 404 every Linux NVIDIA user, exactly as the
    /// missing HIP tarball did between v0.8.26 and v0.8.28. Move these up with the rest as
    /// soon as upstream publishes them.
    /// </summary>
    ...
    private const string LinuxVulkanUrl = "https://github.com/CrispStrobe/CrispASR/releases/download/v0.8.33/crispasr-linux-x86_64-vulkan.tar.gz";
    private const string LinuxHipUrl = "https://github.com/CrispStrobe/CrispASR/releases/download/v0.8.33/crispasr-linux-x86_64-hip.tar.gz";
    private const string LinuxArmUrl = "https://github.com/CrispStrobe/CrispASR/releases/download/v0.8.33/crispasr-linux-arm64.tar.gz";
