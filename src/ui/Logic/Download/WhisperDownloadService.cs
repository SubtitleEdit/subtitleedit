...
public class WhisperDownloadService : IWhisperDownloadService
{
    ...
    private const string WindowsUrl = "https://github.com/SubtitleEdit/support-files/releases/download/whispercpp-186/whisper-blas-bin-x64.zip";
    private const string MacArmUrl = "https://github.com/SubtitleEdit/support-files/releases/download/whispercpp-186/whisper-mac.zip";
    private const string MacX64Url = "https://github.com/SubtitleEdit/support-files/releases/download/whispercpp-186/whisper-mac.zip";
    private const string LinuxUrl = "https://github.com/SubtitleEdit/support-files/releases/download/whispercpp-186/whisper-vulkan-linux64.zip";

    private const string WindowsUrlCuBlass = "https://github.com/ggml-org/whisper.cpp/releases/download/v1.8.6/whisper-cublas-12.4.0-bin-x64.zip";
    private const string WindowsUrlCppVulkan = "https://github.com/SubtitleEdit/support-files/releases/download/whispercpp-186/whisper-vulkan-x64.zip";
    private const string LinuxUrlCuBlass = "https://github.com/SubtitleEdit/support-files/releases/download/whispercpp-186/whisper-cuda-linux64.zip";
