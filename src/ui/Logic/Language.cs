    ...
    public class Language
    {
        ...
        public Language()
        {
            ...
            Main = new LanguageStructure.Main
            {
                ...
                ErrorLoadGZip = "This file seems to be a compressed .gzip file. Subtitle Edit cannot open compressed files.",
...
can edit in same subtitle file (collaboration)",
            ...
            Settings = new LanguageStructure.Settings
            {
                ...
                CopyOriginalTextOnly = "Copy original text only to clipboard (selected lines)",
                CopyOriginalPlainText = "Copy original plain text to clipboard (selected lines)",
