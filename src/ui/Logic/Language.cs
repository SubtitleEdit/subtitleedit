...
can edit in same subtitle file (collaboration)",
            ...
            Statistics = new LanguageStructure.Statistics
            {
                ...
                SingleLineLengthExceedingMaximum = "Single line length - exceeding maximum: {0} ({1:0.00}%)",
                ...
                SingleLineWidthExceedingMaximum = "Single line width - exceeding maximum: {0} ({1:0.00}%)",
                ...
                DurationExceedingMinimum = "Duration - below minimum: {0} ({1:0.00}%)",
                DurationExceedingMaximum = "Duration - exceeding maximum: {0} ({1:0.00}%)",
                ...
                CharactersPerSecondExceedingOptimal = "Characters/sec - exceeding optimal: {0} ({1:0.00}%)",
                CharactersPerSecondExceedingMaximum = "Characters/sec - exceeding maximum: {0} ({1:0.00}%)",
                ...
                WordsPerMinuteExceedingMaximum = "Words/min - exceeding maximum: {0} ({1:0.00}%)",
                GapMinimum = "Gap - minimum: {0:#,##0} ms",
                GapMaximum = "Gap - maximum: {0:#,##0} ms",
                GapAverage = "Gap - average: {0:#,##0.##} ms",
                GapExceedingMinimum = "Gap - below minimum: {0} ({1:0.00}%)",
                Export = "Export...",
            };
