...
can edit in same subtitle file (collaboration)",
            ...
            Settings = new LanguageStructure.Settings
            {
                ...
                RecalculateDurationOfCurrentSubtitleByOptimalCps = "Re-calculate duration of current subtitle (based on optimal CPS)",
                RecalculateDurationOfCurrentSubtitleByMaxCps = "Re-calculate duration of current subtitle (based on maximum CPS)",
...
Keep changes?",
            ...
            Waveform = new LanguageStructure.Waveform
            {
                ...
                RemoveSceneChangesFromSelection = "Remove scene changes from selection",
