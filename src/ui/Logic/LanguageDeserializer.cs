        ...
        private static void SetValue(Language language, XmlReader reader, string name)
        {
            switch (name)
            {
                ...
                case "Main/VideoControls/Stop":
                    ...
                    break;
                case "Main/VideoControls/ToggleOnVideoPreview":
                    language.Main.VideoControls.ToggleOnVideoPreview = reader.Value;
                    break;
                ...
                case "Settings/AdjustExtendToPreviousSceneChangeWithGap":
                    language.Settings.AdjustExtendToPreviousSceneChangeWithGap = reader.Value;
                    break;
