...
namespace Nikse.SubtitleEdit.Forms
{
    public sealed partial class FixCommonErrors : Form, IFixCallbacks
    {
        ...
        private const int Split3PlusLinesIntoMultiParagraphs = 24;
        private const int IndexFixDoubleDash = 25;
        private const int IndexFixDoubleGreaterThan = 26;
        private const int IndexFixContinuationStyle = 27;
        private const int IndexFixMissingOpenBracket = 28;
        private const int IndexFixOcrErrorsViaReplaceList = 29;
        private const int IndexUppercaseIInsideLowercaseWord = 30;
        private const int IndexRemoveSpaceBetweenNumbers = 31;
        private const int IndexDialogsOnOneLine = 32;
        private const int IndexRemoveDashFirstLine = 33;
        private const int IndexNormalizeStrings = 34;
        ...
        private void SaveConfiguration()
        {
            ...
            ce.Split3PlusLinesIntoMultiParagraphs = listView1.Items[Split3PlusLinesIntoMultiParagraphs].Checked;
