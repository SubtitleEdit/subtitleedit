...
namespace Nikse.SubtitleEdit.Forms.Options
{
    public sealed partial class Settings : PositionAndSizeForm
    {
        ...
        private void MakeShortcutsTreeView(LanguageStructure.Settings language)
        {
            ...
            AddNode(createAndAdjustNode, language.RecalculateDurationOfCurrentSubtitleByOptimalCps, nameof(Configuration.Settings.Shortcuts.GeneralAutoCalcCurrentDurationByOptimalCps));
            AddNode(createAndAdjustNode, language.RecalculateDurationOfCurrentSubtitleByMaxCps, nameof(Configuration.Settings.Shortcuts.GeneralAutoCalcCurrentDurationByMaxCps));
