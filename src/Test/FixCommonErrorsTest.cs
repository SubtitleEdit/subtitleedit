...
namespace Test
{
    ...
    public class FixCommonErrorsTest
    {
        ...
        public void StartWithUppercaseAfterParagraphNormal6()
        {
            ...
            var fixedText = FixCommonErrors.FixStartWithUppercaseLetterAfterParagraph(p, prev, System.Text.Encoding.UTF8, "en");
            Assert.AreEqual(fixedText, "Bye" + Environment.NewLine + "...I can't");
        }
        ...
        {
            var prev = new Paragraph("Bye.", 0, 1000);
            var p = new Paragraph("bye" + Environment.NewLine + "...i ", 1200, 5000);
            var fixedText = FixCommonErrors.FixStartWithUppercaseLetterAfterParagraph(p, prev, System.Text.Encoding.UTF8, "pt");
            Assert.AreEqual(fixedText, "Bye" + Environment.NewLine + "...i ");
        }
