...
{
    public class DeepSeekTranslate : IAutoTranslator, IAutoTranslatorWithContext, IDisposable
    {
        ...
        public async Task<string> Translate(string text, string sourceLanguageCode, string targetLanguageCode, string previousLineText, string nextLineText, CancellationToken cancellationToken)
        {
            ...
            var prompt = string.Format(Configuration.Settings.Tools.DeepSeekPrompt, sourceLanguageCode, targetLanguageCode, previousLineText, nextLineText);
