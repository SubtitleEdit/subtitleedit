...
namespace Tests.Logic
{
    ...
    public class ConvertColorsToDialogTest
    {
        ...
        public void TestDialog4()
        {
            ...
            Assert.Equal("- We are going to Ibiza." + Environment.NewLine + "- To where? - Ibiza. - Okay.", result);
        }
        ...
        public void TestDialogAddNewLinesOff()
        {
            ...
            Assert.Equal("Keep on going. -Okay.", result);
        }
        ...
        public void TestDialogAddNewLinesOn()
        {
            ...
            Assert.Equal("Keep on going." + Environment.NewLine + "-Okay.", result);
        }
        ...
        public void TestNoChange2()
        {
            ...
            Assert.Equal("That's it! Sped to victory.", result);
        }
        ...
        public void TestNoChange3()
        {
            ...
            Assert.Equal("<font color=\"#ffff00\">- That was really delicious.</font>" + Environment.NewLine + "- I know.", result);
        }
        ...
        public void TestNoChange5()
        {
            ...
            Assert.Equal("- No, don't touch that-- - <font color=\"#ffff00\">That was stupid.</font>" + Environment.NewLine + "- I know.", result);
        }
        ...
        public void TestNoChange5NoColor()
        {
            ...
            Assert.Equal("- No, don't touch that-- - That was stupid." + Environment.NewLine + "- I know.", result);
        }
        ...
        public void TestPositioning()
        {
            ...
            Assert.Equal("{\\an8}- That was really delicious." + Environment.NewLine + "- I know.", result);
        }
        ...
        public void TestPartialColors()
        {
            ...
            Assert.Equal("- Yes." + Environment.NewLine + "- Red.", result);
        }
        ...
        public void TestPartialColorsThreeLines()
        {
            ...
            Assert.Equal("- Yes." + Environment.NewLine + "- Red." + Environment.NewLine + "- No.", result);
        }
    }
}
