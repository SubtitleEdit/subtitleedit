...
namespace Tests.Logic
{
    ...
    public class UnknownFormatImporterJsonTest
    {
        ...
        'subtitles': [
        {
            ...
            Assert.Equal(11, subtitle.Paragraphs.Count);
            Assert.Equal("development", subtitle.Paragraphs[1].Text);
        }
        ...
        'subtitles': [
        {
            ...
            var subtitle = importer.AutoGuessImport(raw.Replace('\'', '"').SplitToLines());
            Assert.Equal(11, subtitle.Paragraphs.Count);
            Assert.Equal("Ford" + Environment.NewLine + "BMW" + Environment.NewLine + "Fiat", subtitle.Paragraphs[1].Text);
        }
        ...
        public void ImportBilibiliJson()
        {
            ...
            Assert.Equal("Line1", subtitle.Paragraphs[1].Text);
        }
