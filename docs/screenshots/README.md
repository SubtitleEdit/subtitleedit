...
This directory contains documentation screenshots for Subtitle Edit.

All listed files exist on disk. Filenames are stable and may be linked from `../features/*.md` or `../reference/*.md` via `../screenshots/<name>`.
...
- `main-window-layout.png` — Main window layout
...
- `main-waveform-toolbar.png` — Waveform toolbar with play/zoom/set controls
...
- `file-menu.png` — File menu
- `compare.png` — Compare window
- `import-plain-text.png` — Import plain text window
- `export-image-based.png` — Export image based window

## Edit

- `edit-menu.png` — Edit menu
- `find.png` — Find window
- `replace.png` — Replace window
...
- `change-formatting.png` — Change formatting window
- `convert-actors.png` — Convert actors window
- `bridge-gaps.png` — Bridge gaps window
- `adjust-duration.png` — Adjust duration window
- `apply-duration-limits.png` — Apply duration limits window
- `apply-min-gap.png` — Apply minimum gap window
...
- `adjust-all-times.png` — Adjust all times window
- `visual-sync.png` — Visual sync window
- `point-sync.png` — Point sync window
...
- `transparent-subtitles.png` — Transparent subtitles window
- `shot-changes.png` — Shot changes window
...
- `auto-translate.png` — Auto translate window
- `copy-paste-translate.png` — Copy/paste translate window

## Spell Check

- `spell-check.png` — Spell check window
- `find-double-words.png` — Find double words window

## Audio Visualizer

- `audio-visualizer.png` — Audio visualizer standalone
- `waveform-context-menu.png` — Waveform right-click context menu
...
- `assa-apply-advanced-effects.png` — ASSA apply advanced effects window
- `assa-override-tags.png` — ASSA override tags window

## ASSA — Override Tag Examples (`assa/`)

Used by `../reference/assa-override-tags.md` to illustrate individual override tags.

- `assa/alpha-1.png`, `assa/alpha-2.png` — `\alpha`
- `assa/angle-45.png`, `assa/angle-x.png`, `assa/angle-y.png` — `\frx`, `\fry`, `\frz`
- `assa/blurred-edges.png`, `assa/blurred-edges-8.png`, `assa/blurred-edges-outline.png` — `\blur`, `\be`
- `assa/border.png`, `assa/border-width.png`, `assa/border-height.png` — `\bord`, `\xbord`, `\ybord`
- `assa/clip.png`, `assa/iclip.png` — `\clip`, `\iclip`
- `assa/fade-1.gif`, `assa/fade-2.gif` — `\fad`, `\fade`
- `assa/font-scale.png`, `assa/font-scale-x.png`, `assa/font-scale-y.png` — `\fscx`, `\fscy`
- `assa/font-spacing.png` — `\fsp`
- `assa/move-1.gif`, `assa/move-2.gif` — `\move`
- `assa/outline.png` — outline
- `assa/pos-1.png`, `assa/pos-2.png`, `assa/pos-3.png` — `\pos`
- `assa/reset.png` — `\r`
- `assa/shadow.png`, `assa/shadow-x.png`, `assa/shadow-y.png`, `assa/shadow-color.png`, `assa/shadow-normal.png` — `\shad`, `\xshad`, `\yshad`, `\4c`
- `assa/text-shearing-x-1.png`, `assa/text-shearing-y-1.png` — `\fax`, `\fay`
- `assa/transform-1.gif`, `assa/transform-2.gif` — `\t`

## Other

- `subtitle-grid.png` — Subtitle grid standalone
- `subtitle-grid-column-menu.png` — Subtitle grid column menu
- `text-editor.png` — Text editor standalone
- `statistics.png` — Statistics window
