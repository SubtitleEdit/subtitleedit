...
namespace Tests.Logic.SubtitleFormats
{
    ...
    public class Cea708Test
    {
        ...
        public void CommandClearWindows()
        {
            ...
            Assert.Equal(bytes[0], ClearWindows.Id);
        ...
        public void CommandDefineWindow()
        {
            ...
            Assert.Equal(bytes[0], (byte)command.Id);
        ...
        public void CommandDelayCancel()
        {
            ...
            var bytes = command.GetBytes();
            Assert.Single(bytes);
            Assert.Equal(bytes[0], DelayCancel.Id);
        }
        ...
        public void CommandDeleteWindows()
        {
            ...
            var bytes = command.GetBytes();
            Assert.Equal(2, bytes.Length);
            Assert.Equal(bytes[0], DeleteWindows.Id);
            Assert.Equal(0xff, bytes[1]);
        }
        ...
        public void CommandDisplayWindows()
        {
            ...
            var bytes = command.GetBytes();
            Assert.Equal(2, bytes.Length);
            Assert.Equal(bytes[0], DisplayWindows.Id);
            Assert.Equal(0xff, bytes[1]);
        }
        ...
        public void CommandEndOfText()
        {
            ...
            var bytes = command.GetBytes();
            Assert.Single(bytes);
            Assert.Equal(bytes[0], EndOfText.Id);
        }
        ...
        public void CommandHideWindows()
        {
            ...
            var bytes = command.GetBytes();
            Assert.Equal(2, bytes.Length);
            Assert.Equal(bytes[0], HideWindows.Id);
            Assert.Equal(0xff, bytes[1]);
        }
        ...
        public void CommandSetCurrentWindow()
        {
            ...
            var bytes = command.GetBytes();
            Assert.Single(bytes);
            Assert.Equal(bytes[0], SetCurrentWindow.IdStart + 1);
        ...
        public void CommandSetPenAttributes()
        {
            ...
            Assert.Equal(bytes[0], SetPenAttributes.Id);
        ...
        public void CommandSetPenColor()
        {
            ...
            Assert.Equal(bytes[0], SetPenColor.Id);
        ...
        public void CommandSetPenLocation()
        {
            ...
            var bytes = command.GetBytes();
            Assert.Equal(3, bytes.Length);
            Assert.Equal(bytes[0], SetPenLocation.Id);
        ...
        public void CommandSetWindowAttributes()
        {
            ...
            Assert.Equal(bytes[0], SetWindowAttributes.Id);
            Assert.Equal(140, bytes[1]);
        ...
        public void CommandToggleWindows()
        {
            ...
            var bytes = command.GetBytes();
            Assert.Equal(2, bytes.Length);
            Assert.Equal(bytes[0], ToggleWindows.Id);
            Assert.Equal(145, bytes[1]);
        }
