...
CreateDesktopIcon=Snelkoppeling op het &bureaublad maken
CreateQuickLaunchIcon=Snelkoppeling op de werkbalk &Snel starten maken
ProgramOnTheWeb=%1 op internet
UninstallProgram=%1 verwijderen
LaunchProgram=%1 &starten
AssocFileExtension=%2-bestanden openen met %1
AssocingFileExtension=Bestandsextensie %2 koppelen aan %1...
AutoStartProgramGroupDescription=Opstarten:
AutoStartProgram=%1 automatisch starten
AddonHostProgramNotFound=%1 kan niet worden gevonden in de geselecteerde map.%n%nWilt u toch doorgaan?
