...
# nuget-sources.json and src/UI_RENAME/packages.lock.json alongside the manifest.
#
...
PROJECT_PATH="${1:-src/UI_RENAME/UI.csproj}"
...
echo "  Commit this file alongside src/UI_RENAME/packages.lock.json and the manifest."
