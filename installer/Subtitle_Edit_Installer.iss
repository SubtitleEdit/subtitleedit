...
Source: {#bindir}\SevenZipExtractor.dll;           DestDir: {app};                                    Flags: ignoreversion; Components: main
Source: {#bindir}\x86\7z.dll;                      DestDir: {app}\x86;                                Flags: ignoreversion; Components: main
Source: {#bindir}\x64\7z.dll;                      DestDir: {app}\x64;                                Flags: ignoreversion; Components: main
...
Type: files;      Name: {app}\SevenZipExtractor.dll;                  Check: IsUpgrade()
Type: files;      Name: {app}\x86\7z.dll;                             Check: IsUpgrade()
Type: files;      Name: {app}\x64\7z.dll;                             Check: IsUpgrade()
