...
namespace Nikse.SubtitleEdit.Core
{
    ...
    public class ToolsSettings
    {
        ...
        public bool AdjustDurationAllowOverlap { get; set; }
        ...
        public ToolsSettings()
        {
            ...
            AdjustDurationAllowOverlap = false;
...
";
    ...
    public class Settings
    {
        ...
        private static Settings CustomDeserialize(string fileName)
        {
            ...
            subNode = node.SelectSingleNode("AdjustDurationAllowOverlap");
            if (subNode != null)
            {
                settings.Tools.AdjustDurationAllowOverlap = Convert.ToBoolean(subNode.InnerText);
            }
        ...
        private static void CustomSerialize(string fileName, Settings settings)
        {
            ...
            using (var textWriter = XmlWriter.Create(sb, xws))
            {
                ...
                textWriter.WriteElementString("AdjustDurationAllowOverlap", settings.Tools.AdjustDurationAllowOverlap.ToString(CultureInfo.InvariantCulture));
