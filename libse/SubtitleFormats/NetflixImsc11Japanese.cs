...
".Replace('\'', '"');
        ...
        public override string ToText(Subtitle subtitle, string title)
        {
            ...
            {
                var paragraphNode = MakeParagraph(subtitle, xml, p);
        ...
        private XmlNode MakeParagraph(Subtitle subtitle, XmlDocument xml, Paragraph p)
        {
        ...
        private string GetRegionFromText(string text)
        {
        ...
        private string GetAssStyleFromRegion(string region)
        {
            switch (region)
            {
                ...
                case "left": return @"{\an4\frz-90\fn@}";
                case "right": return @"{\an6\frz-90\fn@}";
