...
can edit in same subtitle file (collaboration)",
            ...
            Settings = new LanguageStructure.Settings
            {
                ...
                NameOrWordMustBeGreaterThanOneCharacter = "Name/word must be greater than one character!",
                InvalidLanguageSelected = "Invalid language selected!",
                InvalidKeyValue = "Invalid key/value",
                RemoveX = "Remove {0}?",
