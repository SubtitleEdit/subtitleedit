...
can edit in same subtitle file (collaboration)",
            ...
            Settings = new LanguageStructure.Settings
            {
                ...
                ExtendToSceneChangeBehavior = "Extend behavior",
                ExtendToSceneChangeBehaviorNormal = "To next scene change",
                ExtendToSceneChangeBehaviorTwoFrames = "Two frames before next scene change (NETFLIX)",
