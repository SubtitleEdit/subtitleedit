    ...
    public class Language
    {
        ...
        public Language()
        {
            ...
            FixCommonErrors = new LanguageStructure.FixCommonErrors
            {
                ...
                RemoveHyphensSingleLine = "Remove dialog hyphens in single lines",
                XHyphensSingleLineRemoved = "Dialog hyphen removed in single lines: {0}",
                FixHyphensInDialogs = "Fix hyphens in dialogs via style: {0}",
                XHyphensInDialogsFixed = "Hyphens fixed: {0}",
