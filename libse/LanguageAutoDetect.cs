...
namespace Nikse.SubtitleEdit.Core
{
    public static class LanguageAutoDetect
    {
        ...
        private static readonly string[] AutoDetectWordsArabic = { "من", "هل", "لا", "فى", "لقد", "ما", "مذا", "افذٍ", "دٍلٍس", "افآل", "مذم", "ألت", "إلم", "غفٍلا", "لحل", "افأكر" };
        ...
        public static string AutoDetectGoogleLanguageOrNull(Subtitle subtitle)
        {
            ...
            s.RemoveEmptyLines();
            string languageId = AutoDetectGoogleLanguage(s.GetAllTexts(true), s.Paragraphs.Count / 14);
        ...
        public static string AutoDetectLanguageName(string languageName, Subtitle subtitle)
        {
            ...
            string text = subtitle.GetAllTexts(true);
